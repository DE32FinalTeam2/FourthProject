...
| **FR-05**           | 데이터 수집 및 변환 | 최종 프로젝트에서 사용할 AirFlow가 실행 가능해야 한다.                                                     | 🟠 중간       | ✅ 완료        |
| **FR-06**           | 데이터 분산 처리    | 최종 프로젝트에서 사용할 Spark 모니터링 및 Auto Scale Out                                                  | 🔴 높음       | ❌ 미완료        |
...
| ✅ **완료**       | 데이터 수집 및 변환   | 데이터 수집 및 변환을 위한 Airflow 도커로 실행 |
| ✅ **완료**       | 데이터 분산 처리      | 데이터 분산처리 기능 동작을 위한 Spark 도커로 실행 |
| ❌ **미완료**     | Spark 모니터링        | Spark를 Grafana로 모니터링              |
| ❌ **미완료**     | Spark Worker Auto Scale out | Spark CPU 제한량에 따른 Worker Auto Scale Out  |
